<html>
    ...
    <p id="head">Create an account</p>
    <form name="registration" id="registration" action="test.php" method="post" onsubmit="return validateform(this);">
    <table border="0">
	...
	<input class="myButton" id="signUpB1" type="reset" value="Clear all fields"></th>
	<td><input class="myButton" id="signUpB2" type="submit" value="Submit"></td>
