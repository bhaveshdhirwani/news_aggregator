<html>
	...
	<body>
		...
		<form action="insertSliderComment.php" method="POST">
		...
		<?php
			...
			echo "<p>"."<textarea name='commentText' rows='5' cols='60' style='font-size:18'></textarea><br>
			...
			if(count($res)>0)
			{
				foreach($res as $row)
				{
					echo "<div style='max-width:620px;background-color:#D6C0BB'>"."<b>".$row['fname']." ".$row['lname']."</b><br>".$row['comment']."</div><br>";
				}
			}
		?>
		</div>
