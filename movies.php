...
rssfeed_url[0]="https://news.google.com/news/rss/search/section/q/movies/movies?hl=en-IN&ned=in";  
...
rssfeed_no_items="0"; 
rssfeed_cache = "b74c77bd9b97f7b634db3fa612350dc2";  
//--> 
</script> 
...
<!-- end rss-feed code -->
			...
			<ul>
				...
				<div id="two">
					<div id="innerTwo"><p>
					<?php
							$sql="SELECT * FROM news where category='movies'";
