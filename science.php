...
rssfeed_url[0]="https://news.google.com/news/rss/headlines/section/topic/SCIENCE?ned=us&hl=en&gl=US";  
...
rssfeed_no_items="0"; 
rssfeed_cache = "2fb5b7eb1d1d7c8c7d1e33e53e3ca135"; 
//--> 
</script> 
...
<!-- end sw-rss-feed code --> 
			...
			<ul>
				...
				<div id="two">
					<div id="innerTwo"><p>
					<?php
							$sql="SELECT * FROM news where category='science'";
