...
rssfeed_url[0]="https://news.google.com/news/rss/search/section/q/books/books?hl=en-IN&ned=in";  
...
rssfeed_no_items="0"; 
rssfeed_cache = "fc9de316694143692ee884219e7de3f2"; 
//--> 
</script> 
...
<!-- end rss-feed code -->
			...
			<ul>
				...
				<div id="two">
					<div id="innerTwo"><p>
					<?php
							$sql="SELECT * FROM news where category='books'";
