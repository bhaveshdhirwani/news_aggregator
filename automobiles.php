...
rssfeed_url[0]="https://news.google.com/news/rss/search/section/q/automobiles%20news/automobiles%20news?hl=en-IN&ned=in";  
...
rssfeed_no_items="0"; 
rssfeed_cache = "0c0f9b16552496e2920144426909ed9d"; 
//--> 
</script> 
...
<!-- end rss-feed code -->
			...
			<ul>
				...
				<div id="two">
					<div id="innerTwo"><p>
					<?php
							$sql="SELECT * FROM news where category='automobiles'";
