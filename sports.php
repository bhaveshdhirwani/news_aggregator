...
rssfeed_url[0]="https://news.google.com/news/rss/headlines/section/topic/SPORTS.en_in/Sports?ned=in&hl=en-IN";  
...
rssfeed_no_items="0"; 
rssfeed_cache = "642ef7849d92adfb91f6294331587886";  
//--> 
</script> 
...
<!-- end rss-feed code -->
			...
			<ul>
				...
				<div id="two">
					<div id="innerTwo"><p>
					<?php
							$sql="SELECT * FROM news where category='sports'";
