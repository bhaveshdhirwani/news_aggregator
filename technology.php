...
rssfeed_url[0]="https://news.google.com/news/rss/headlines/section/topic/TECHNOLOGY.en_in/Technology?ned=in&hl=en-IN";  
...
rssfeed_no_items="0"; 
rssfeed_cache = "8be4e19d110399c6c33025eb3bc4dbee"; 
//--> 
</script> 
...
<!-- end rss-feed code -->
			...
			<ul>
				...
				<div id="two">
					<div id="innerTwo"><p>
					<?php
							$sql="SELECT * FROM news where category='technology'";
