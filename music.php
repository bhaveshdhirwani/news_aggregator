...
rssfeed_url[0]="https://news.google.com/news/rss/search/section/q/music/music?hl=en-IN&ned=in";  
...
rssfeed_no_items="0"; 
rssfeed_cache = "e7f0393db33ba3ec408c42c63f5c7ea1"; 
//--> 
</script> 
...
<!-- end rss-feed code -->
			...
			<ul>
				...
				<div id="two">
					<div id="innerTwo"><p>
					<?php
							$sql="SELECT * FROM news where category='music'";
