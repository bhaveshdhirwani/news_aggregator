...
rssfeed_url[0]="https://news.google.com/news/rss/search/section/q/fashion/fashion?hl=en-IN&ned=in";  
...
rssfeed_no_items="0"; 
rssfeed_cache = "481b74c0a244dd2566829a9f1ede3129"; 
//--> 
</script> 
...
<!-- end rss-feed code -->
			...
			<ul>
				...
				<div id="two">
					<div id="innerTwo"><p>
					<?php
							$sql="SELECT * FROM news where category='fashion'";
