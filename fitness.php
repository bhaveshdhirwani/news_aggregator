...
rssfeed_url[0]="https://news.google.com/news/rss/headlines/section/topic/HEALTH.en_in/Health?ned=in&hl=en-IN";  
...
rssfeed_no_items="0"; 
rssfeed_cache = "aa1bd557a9d648d9ea103a536b88db51"; 
//--> 
</script> 
...
<!-- end rss-feed code -->
			...
			<ul>
				...
				<div id="two">
					<div id="innerTwo"><p>
					<?php
							$sql="SELECT * FROM news where category='fitness'";
